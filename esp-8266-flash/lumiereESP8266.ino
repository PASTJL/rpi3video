...
void loop() {
    ...
    if((WiFiMulti.run() == WL_CONNECTED)) {
        ...
        //  - /etc/apache2/sites-available/000-default.conf ( virtualhost port 8853) 
        //  - /etc/apache2/ports.conf ( Listen 8853 mais on peut choir un autre port autre que 80 et 8080) 
        // Gestion d une lampe d eclairage
        http.begin("http://raspberrypi:8853/lumiere.cam"); //HTTP
